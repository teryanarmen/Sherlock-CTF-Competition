...
export interface SwissTreasuryInterface extends utils.Interface {
  contractName: "SwissTreasury";
  functions: {
  ...
  events: {
    ...
    "DistributeFundsExecuted(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "DistributeFundsExecuted"): EventFragment;
...
export type DistributeFundsExecutedEvent = TypedEvent<
  [string, BigNumber],
  { target: string; value: BigNumber }
>;

export type DistributeFundsExecutedEventFilter =
  TypedEventFilter<DistributeFundsExecutedEvent>;
...
export interface SwissTreasury extends BaseContract {
  contractName: "SwissTreasury";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwissTreasuryInterface;
  ...
  filters: {
    ...
    "DistributeFundsExecuted(address,uint256)"(
      target?: string | null,
      value?: null
    ): DistributeFundsExecutedEventFilter;
    DistributeFundsExecuted(
      target?: string | null,
      value?: null
    ): DistributeFundsExecutedEventFilter;
